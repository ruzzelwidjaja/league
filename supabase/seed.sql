...
INSERT INTO "public"."league_members" ("id", "leagueId", "userId", "rank", "skillTier", "status", "joinedAt", "recentRejections", "recentAcceptances", "activityWindowStart", "previousRank", "availability", "ootDaysUsed") VALUES
	...
	('fc0c39d3-2a6f-4a51-b745-3366dcf05869', 'd3094789-261f-45c3-9d6a-aa12fe13acb3', '26c90fc7-2719-4fe0-9346-65660b0752d0', 4, 'middle', 'active', '2025-07-02 23:55:39.557+00', 0, 0, NULL, 6, '{"tuesday": {"lunch": true, "after_work": true}, "thursday": {"lunch": true, "after_work": true}, "wednesday": {"lunch": true, "after_work": true}}', 0),
